...
.field private static final EVENT_SET_NETWORK_DONE:I = 0x2

.field private static final EVENT_SHOW_MESSAGE:I = 0x3

.field private static final EVENT_SIM_LOADED:I = 0x4
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 176
    iput-object v2, p0, Lcom/android/internal/telephony/SubscriptionController;->mProgressDialog:Landroid/app/ProgressDialog;
    ...
    iput v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mPendingPrimaryCardSubId:I
...
.method static synthetic access$500(Lcom/android/internal/telephony/SubscriptionController;Ljava/lang/String;I)I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionController;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
...
.method static synthetic access$700(Lcom/android/internal/telephony/SubscriptionController;Landroid/os/AsyncResult;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionController;
...
.method static synthetic access$800(Lcom/android/internal/telephony/SubscriptionController;)Lcom/android/internal/telephony/dataconnection/DdsSchedulerAc;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/SubscriptionController;
...
.method private getSubInfo(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/List;
    ...
    :goto_5
    :try_start_3
    const-string v0, "database exception"
...
.method private showProgressDialog()V
    ...
    .line 244
    iget-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mProgressDialog:Landroid/app/ProgressDialog;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mProgressDialog:Landroid/app/ProgressDialog;
...
.method private updateDataSubId(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/infocollect/InfoCollector;->endSimSwitch()V
...
.method public addSubInfoRecord(Ljava/lang/String;I)I
    ...
    :cond_c
    :goto_5
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/SubscriptionController;->updateAllDataConnectionTrackers()V
    ...
    :try_start_3
    const-string v3, "[addSubInfoRecord]Error:query"
...
.method public getIccid(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfoForSimSlotIndex(I)Landroid/telephony/SubscriptionInfo;
...
.method public setDataSub(I)V
    .locals 7
    .param p1, "subId"    # I

    .prologue
    .line 1614
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->getSimStateForSubscriber(I)I
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/SubscriptionController;->mHandler:Landroid/os/Handler;
    ...
    invoke-interface {v0, v3, v4, v5}, Lcom/android/internal/telephony/Phone;->registerForSimRecordsLoaded(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 1625
    :cond_0
    iget-object v3, p0, Lcom/android/internal/telephony/SubscriptionController;->mDctController:Lcom/android/internal/telephony/dataconnection/DctController;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/SubscriptionController;->mDctController:Lcom/android/internal/telephony/dataconnection/DctController;

    .line 1627
    iget-object v3, p0, Lcom/android/internal/telephony/SubscriptionController;->mDctController:Lcom/android/internal/telephony/dataconnection/DctController;

    iget-object v4, p0, Lcom/android/internal/telephony/SubscriptionController;->mDataConnectionHandler:Lcom/android/internal/telephony/SubscriptionController$DataConnectionHandler;

    const/4 v5, 0x1

    const/4 v6, 0x0

    invoke-virtual {v3, v4, v5, v6}, Lcom/android/internal/telephony/dataconnection/DctController;->registerForDefaultDataSwitchInfo(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 1630
    :cond_1
    iget-object v3, p0, Lcom/android/internal/telephony/SubscriptionController;->mDctController:Lcom/android/internal/telephony/dataconnection/DctController;

    invoke-virtual {v3, p1}, Lcom/android/internal/telephony/dataconnection/DctController;->setDefaultDataSubId(I)V
...
.method public setDataSubId(I)V
    ...
    .line 1639
    iget-boolean v2, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsMBNEnable:Z
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/internal/telephony/primarycard/PrimaryCardController;->getMode(ILjava/lang/String;)I
...
.method public setDefaultDataSubId(I)V
    ...
    const-string v5, "[setDefaultDataSubId] subId="
    ...
    iget-boolean v5, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsMBNEnable:Z
    ...
    .line 1555
    iget-boolean v4, p0, Lcom/android/internal/telephony/SubscriptionController;->mIsMBNEnable:Z
    ...
    invoke-virtual {v4, p1}, Lcom/android/internal/telephony/infocollect/InfoCollector;->startSimSwitch(I)V

    .line 1559
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->setDataSub(I)V
    ...
    const-string v5, "[setDefaultDataSubId] auto="
    ...
    const-string v5, ";isPrimaryCardConfigProcess:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, p0, Lcom/android/internal/telephony/SubscriptionController;->isPrimaryCardConfigProcess:Z
    ...
    .line 1566
    iget-boolean v4, p0, Lcom/android/internal/telephony/SubscriptionController;->isPrimaryCardConfigProcess:Z

    if-eqz v4, :cond_4

    .line 1567
    iput p1, p0, Lcom/android/internal/telephony/SubscriptionController;->mPendingPrimaryCardSubId:I
    ...
    .line 1571
    .local v3, "recorder":Landroid/telephony/SubscriptionInfo;
    if-eqz v3, :cond_2
    ...
    .line 1577
    iput-boolean v10, p0, Lcom/android/internal/telephony/SubscriptionController;->isPrimaryCardConfigProcess:Z
    ...
    const-string v5, "com.lenovo.leos.simsettings"

    const-string v6, "com.lenovo.leos.simsettings.DataSwitchActivity"
    ...
    invoke-virtual {v3}, Landroid/telephony/SubscriptionInfo;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/primarycard/PrimaryCardController;->getPrimarySlot()I
    ...
    .line 1596
    :cond_7
    iget-object v4, p0, Lcom/android/internal/telephony/SubscriptionController;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v4, v5, v6, v10, v7}, Lcom/android/internal/telephony/primarycard/PrimaryCardController;->setPreferredNetwork(ILjava/lang/String;ZLandroid/os/Message;)V
    ...
    invoke-virtual {v4, v9}, Lcom/android/internal/telephony/primarycard/PrimaryCardController;->setRestoreDdsToPrimarySub(Z)V

    .line 1599
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->setDataSubId(I)V

    .line 1600
    iput-boolean v9, p0, Lcom/android/internal/telephony/SubscriptionController;->isPrimaryCardConfigProcess:Z
    ...
    .line 1606
    .end local v0    # "dataset":I
    .end local v3    # "recorder":Landroid/telephony/SubscriptionInfo;
    :cond_9
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/SubscriptionController;->setDataSub(I)V
...
.method public setDisplayNumber(Ljava/lang/String;I)I
    ...
    const-string v7, "[setDisplayNumber]+ number:"
    ...
    .line 1112
    :cond_0
    const-string v6, "[setDispalyNumber]- fail"
    ...
    invoke-virtual {v6, p2}, Landroid/telephony/TelephonyManager;->getLine1AlphaTagForSubscriber(I)Ljava/lang/String;
    ...
    iput-boolean v6, p0, Lcom/android/internal/telephony/SubscriptionController;->mSuccess:Z
    ...
    invoke-interface {v1, v0, p1, v3}, Lcom/android/internal/telephony/Phone;->setLine1Number(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public setIMSStatusToModem()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/SubscriptionController;->getPhoneId(I)I
    ...
    invoke-virtual {v3, v6, v8}, Lcom/android/internal/telephony/PhoneProxy;->setUEMode(ILandroid/os/Message;)V
    ...
    invoke-virtual {v3, v7, v8}, Lcom/android/internal/telephony/PhoneProxy;->setUEMode(ILandroid/os/Message;)V
...
.method public updateAllDataConnectionTrackers()V
    .locals 4
...
.method public updateUserPrefs(Z)V
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/SubscriptionController;->setDataSub(I)V
    ...
    .line 1979
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/SubscriptionController;->setDataSub(I)V

    .line 1982
    :cond_3
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/SubscriptionController;->setDefaultFallbackSubId(I)V
    ...
    invoke-virtual {v8}, Lcom/android/internal/telephony/ModemStackController;->getPrimarySub()I

    move-result v8

    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/SubscriptionController;->getSubId(I)[I
