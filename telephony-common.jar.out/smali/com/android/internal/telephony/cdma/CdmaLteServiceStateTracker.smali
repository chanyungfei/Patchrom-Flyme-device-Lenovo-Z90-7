...
.method protected onSignalStrengthResult(Landroid/os/AsyncResult;Z)Z
    ...
    invoke-super {p0, p1, v2}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->onSignalStrengthResult(Landroid/os/AsyncResult;Z)Z
...
.method protected pollStateDone()V
    ...
    invoke-virtual/range {v44 .. v45}, Lcom/android/internal/telephony/cdma/CDMAPhone;->isMccMncMarkedAsNonRoaming(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v44 .. v45}, Lcom/android/internal/telephony/cdma/CDMAPhone;->isSidMarkedAsNonRoaming(I)Z
    ...
    .line 336
    :cond_0
    const-string v44, "pollStateDone: override - marked as non-roaming."
    ...
    invoke-virtual/range {v44 .. v45}, Landroid/telephony/ServiceState;->setCdmaEriIconIndex(I)V
    ...
    .line 443
    const-string v44, "persist.radio.uim.gpio"
    ...
    .line 447
    .local v39, "sim_state":I
    new-instance v44, Ljava/lang/StringBuilder;

    invoke-direct/range {v44 .. v44}, Ljava/lang/StringBuilder;-><init>()V

    const-string v45, "Avatar data collect, hotSwap gpio state = "
    ...
    iput-wide v0, v2, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mOutOfServiceTime:J
    ...
    const-string v45, "Avatar data collect, Out of service, mLastSid = "
    ...
    iget v0, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mLastSid:I
    ...
    iget v0, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mLastNid:I
    ...
    iget v0, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mLastBid:I
    ...
    iget-wide v0, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mOutOfServiceTime:J
    ...
    const-string v45, "Avatar data collect, last in service, mLastSid = "
    ...
    const-string v45, "Avatar data collect, lost signal time =  "
    ...
    .line 468
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->getStoredRoamingOperNum()Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mRoamingOperator:Ljava/lang/String;

    .line 469
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->getStoredRoamingStartTime()J
    ...
    iput-wide v0, v2, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mRoamingStartTime:J

    .line 470
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mRoamingOperator:Ljava/lang/String;
    ...
    const-string v45, "avatar data collect, roaming over operators, mRoamingOperator = "
    ...
    iget-wide v0, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mRoamingStartTime:J
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->storeRoamingOperNum(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->storeRoamingStartTime(J)V
    ...
    invoke-virtual/range {v44 .. v46}, Lcom/android/internal/telephony/cdma/CDMAPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v9, v0, Lcom/android/internal/telephony/cdma/CdmaLteServiceStateTracker;->mCellInfo:Landroid/telephony/CellInfo;

    check-cast v9, Landroid/telephony/CellInfoLte;

    .line 689
    .local v9, "cil":Landroid/telephony/CellInfoLte;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v9, v0}, Landroid/telephony/CellInfoLte;->setRegistered(Z)V
    ...
    invoke-virtual {v9, v0}, Landroid/telephony/CellInfoLte;->setCellIdentity(Landroid/telephony/CellIdentityLte;)V
    ...
    .end local v8    # "cidChanged":Z
    .end local v9    # "cil":Landroid/telephony/CellInfoLte;
    ...
    invoke-virtual/range {v44 .. v45}, Lcom/android/internal/telephony/cdma/CDMAPhone;->isMccMncMarkedAsRoaming(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {v44 .. v45}, Lcom/android/internal/telephony/cdma/CDMAPhone;->isSidMarkedAsRoaming(I)Z
    ...
    .line 341
    :cond_20
    const-string v44, "pollStateDone: override - marked as roaming."
    ...
    invoke-virtual/range {v44 .. v45}, Landroid/telephony/ServiceState;->setCdmaEriIconMode(I)V
    ...
    const-string v45, "Avatar data collect, mRoamingOperator = "
    ...
    .restart local v9    # "cil":Landroid/telephony/CellInfoLte;
    :cond_39
    const/4 v8, 0x0
