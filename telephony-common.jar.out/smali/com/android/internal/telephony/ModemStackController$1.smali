...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    # getter for: Lcom/android/internal/telephony/ModemStackController;->mContext:Landroid/content/Context;
    invoke-static {v6}, Lcom/android/internal/telephony/ModemStackController;->access$200(Lcom/android/internal/telephony/ModemStackController;)Landroid/content/Context;
    ...
    invoke-virtual {v6}, Landroid/telephony/SubscriptionManager;->getAllSubscriptionInfoCount()I
    ...
    # getter for: Lcom/android/internal/telephony/ModemStackController;->mUpdateStackMsg:Landroid/os/Message;
    invoke-static {v6}, Lcom/android/internal/telephony/ModemStackController;->access$300(Lcom/android/internal/telephony/ModemStackController;)Landroid/os/Message;
    ...
    # getter for: Lcom/android/internal/telephony/ModemStackController;->mUpdateStackMsg:Landroid/os/Message;
    invoke-static {v7}, Lcom/android/internal/telephony/ModemStackController;->access$300(Lcom/android/internal/telephony/ModemStackController;)Landroid/os/Message;

    move-result-object v7

    # invokes: Lcom/android/internal/telephony/ModemStackController;->sendResponseToTarget(Landroid/os/Message;I)V
    invoke-static {v6, v7, v8}, Lcom/android/internal/telephony/ModemStackController;->access$400(Lcom/android/internal/telephony/ModemStackController;Landroid/os/Message;I)V

    .line 209
    iget-object v6, p0, Lcom/android/internal/telephony/ModemStackController$1;->this$0:Lcom/android/internal/telephony/ModemStackController;

    # setter for: Lcom/android/internal/telephony/ModemStackController;->mUpdateStackMsg:Landroid/os/Message;
    invoke-static {v6, v10}, Lcom/android/internal/telephony/ModemStackController;->access$302(Lcom/android/internal/telephony/ModemStackController;Landroid/os/Message;)Landroid/os/Message;
    ...
    invoke-static {v6}, Lcom/android/internal/telephony/ModemStackController;->access$500(Lcom/android/internal/telephony/ModemStackController;)Z
    ...
    invoke-static {v6}, Lcom/android/internal/telephony/ModemStackController;->access$600(Lcom/android/internal/telephony/ModemStackController;)Ljava/util/HashMap;
    ...
    invoke-virtual {v6, v12, v7}, Lcom/android/internal/telephony/ModemStackController;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-static {v2, v6, v10}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
