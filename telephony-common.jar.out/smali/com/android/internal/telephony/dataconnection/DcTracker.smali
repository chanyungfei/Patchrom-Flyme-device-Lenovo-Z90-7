...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 249
    sget-object v4, Lcom/android/internal/telephony/dataconnection/DcTracker;->mAllPhones:[Lcom/android/internal/telephony/PhoneBase;
...
.method private getLocAreaCode()I
    .locals 3
...
.method private getLocation()Ljava/lang/String;
    ...
    .line 3200
    .local v3, "loc":Landroid/telephony/CellLocation;
    if-eqz v3, :cond_1
    ...
    .end local v3    # "loc":Landroid/telephony/CellLocation;
    ...
    .line 3205
    .restart local v3    # "loc":Landroid/telephony/CellLocation;
    :cond_0
...
.method private isDataAllowed(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    ...
    .line 835
    const-string v1, "isDataAllowed:DefaultDataSubId != DemandDataSubId, return false"
...
.method public dispose()V
    ...
    .line 335
    sget-object v1, Lcom/android/internal/telephony/dataconnection/DcTracker;->mAllPhones:[Lcom/android/internal/telephony/PhoneBase;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "handleMessage even not activate sub allow msg "
    ...
    .line 3037
    :cond_5
    const-string v4, "handleMessage Ignore msgs since phone is not the current DDS"
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    .line 2150
    const-string v30, "onDataSetupComplete: no connection to DC, handle as error"
    ...
    const-string v31, "onDataSetupComplete: No apnContext"
    ...
    const-string v31, "onDataSetupComplete: success apn="
    ...
    .line 2161
    .local v26, "port":Ljava/lang/String;
    ...
    const-string v26, "8080"

    .line 2162
    :cond_4
    new-instance v27, Landroid/net/ProxyInfo;
    ...
    .line 2164
    .local v27, "proxy":Landroid/net/ProxyInfo;
    move-object/from16 v0, v27
    ...
    .line 2172
    .end local v26    # "port":Ljava/lang/String;
    .end local v27    # "proxy":Landroid/net/ProxyInfo;
    :cond_5
    :goto_2
    ...
    .line 2173
    const-string v30, "gsm.defaultpdpcontext.active"
    ...
    .line 2175
    const-string v30, "onDataSetupComplete: PREFERED APN is null"
    ...
    :cond_6
    :goto_3
    sget-object v30, Lcom/android/internal/telephony/DctConstants$State;->CONNECTED:Lcom/android/internal/telephony/DctConstants$State;
    ...
    invoke-static/range {v30 .. v30}, Landroid/net/ConnectivityManager;->from(Landroid/content/Context;)Landroid/net/ConnectivityManager;
    ...
    invoke-virtual/range {v30 .. v31}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    const-string v31, "onDataSetupComplete: SETUP complete type="
    ...
    const-string v31, "onDataSetupComplete: NumberFormatException making ProxyProperties ("
    ...
    const-string v31, "onDataSetupComplete: successful, BUT send connected to prov apn as mIsProvisioning:"
    ...
    const-string v31, " && (isProvisioningApn:"
    ...
    .line 2215
    new-instance v30, Lcom/android/internal/telephony/dataconnection/DcTracker$ProvisionNotificationBroadcastReceiver;
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/telephony/TelephonyManager;->getNetworkOperatorName()Ljava/lang/String;
    ...
    invoke-direct/range {v32 .. v33}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    invoke-virtual/range {v30 .. v32}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    const-string v30, "android.intent.action.DATA_CONNECTION_CONNECTED_TO_PROVISIONING_APN"
    ...
    .line 2235
    const-string v30, "linkProperties"
    ...
    .line 2242
    .local v24, "networkCapabilities":Landroid/net/NetworkCapabilities;
    if-eqz v24, :cond_d

    .line 2243
    const-string v30, "networkCapabilities"
    ...
    .end local v24    # "networkCapabilities":Landroid/net/NetworkCapabilities;
    :cond_e
    move-object/from16 v0, p1
    ...
    check-cast v30, Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getLocAreaCode()I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getLocation()Ljava/lang/String;
    ...
    sget-object v31, Lcom/android/internal/telephony/dataconnection/DcFailCause;->ERROR_UNSPECIFIED:Lcom/android/internal/telephony/dataconnection/DcFailCause;
    ...
    const-string v31, "avatar data collect, setup data fail cause =  "
    ...
    const-string v31, "onDataSetupComplete: error apn=%s cause=%s"
    ...
    .line 2300
    const-string v30, "onDataSetupComplete: WaitingApns.size=%d WaitingApnsPermFailureCountDown=%d"
...
.method protected onVoiceCallEnded()V
    ...
    .line 2512
    iget-object v0, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPendingRemoveRequest:Landroid/net/NetworkRequest;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPendingRemoveRequest:Landroid/net/NetworkRequest;

    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/SubscriptionController;->stopOnDemandDataSubscriptionRequest(Landroid/net/NetworkRequest;)V

    .line 2514
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mPendingRemoveRequest:Landroid/net/NetworkRequest;
...
.method protected registerForAllEvents()V
    ...
    invoke-interface {v2, p0, v3, v5}, Lcom/android/internal/telephony/CommandsInterface;->registerForWwanIwlanCoexistence(Landroid/os/Handler;ILjava/lang/Object;)V
