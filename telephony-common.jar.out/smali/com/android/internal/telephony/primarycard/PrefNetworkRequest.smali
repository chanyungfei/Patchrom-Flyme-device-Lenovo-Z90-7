...
.method public constructor <init>(Landroid/content/Context;IIZLandroid/os/Message;)V
    ...
    .line 152
    sget-object v3, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;->sSyncQueue:Lcom/android/internal/telephony/primarycard/SyncQueue;

    invoke-direct {p0, v3}, Lcom/android/internal/telephony/primarycard/SyncQueue$SyncRequest;-><init>(Lcom/android/internal/telephony/primarycard/SyncQueue;)V

    .line 63
    const/4 v3, 0x0

    iput-boolean v3, p0, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;->mBootup:Z
    ...
    iput-boolean v3, p0, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;->mIsMBNEnable:Z

    .line 70
    new-instance v3, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest$1;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v3, p0, v4}, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest$1;-><init>(Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;Landroid/os/Looper;)V

    iput-object v3, p0, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;->mHandler:Landroid/os/Handler;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;->commands:Ljava/util/List;
    ...
    iget-boolean v3, p0, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;->mIsMBNEnable:Z
    ...
    invoke-virtual {v3, p2}, Landroid/telephony/TelephonyManager;->getSimAppType(I)Ljava/lang/String;

    move-result-object v2

    .line 166
    .local v2, "simapp":Ljava/lang/String;
    ...
    .line 172
    .end local v2    # "simapp":Ljava/lang/String;
    :cond_1
    :goto_0
    if-eq p3, v6, :cond_5
    ...
    new-instance v4, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest$PrefNetworkSetCommand;

    const/16 v5, 0x14

    invoke-direct {v4, p0, v0, v5, v7}, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest$PrefNetworkSetCommand;-><init>(Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;IILcom/android/internal/telephony/primarycard/PrefNetworkRequest$1;)V
    ...
    .restart local v2    # "simapp":Ljava/lang/String;
    :cond_3
    const/16 p3, 0x14
    ...
    invoke-direct {v4, p0, v0, v6, v7}, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest$PrefNetworkSetCommand;-><init>(Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;IILcom/android/internal/telephony/primarycard/PrefNetworkRequest$1;)V
    ...
    invoke-direct {v4, p0, p2, p3, v7}, Lcom/android/internal/telephony/primarycard/PrefNetworkRequest$PrefNetworkSetCommand;-><init>(Lcom/android/internal/telephony/primarycard/PrefNetworkRequest;IILcom/android/internal/telephony/primarycard/PrefNetworkRequest$1;)V
