...
.method private handlePackageAvailable(Ljava/lang/String;)V
    ...
    .line 231
    iget-object v4, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mContext:Landroid/content/Context;
    ...
    iget-object v4, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mAccessibilityServices:Ljava/util/List;
    ...
    invoke-static {v4}, Lcom/lenovo/settings/search/Index;->getInstance(Landroid/content/Context;)Lcom/lenovo/settings/search/Index;
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/lenovo/settings/search/Index;->updateFromClassNameResource(Ljava/lang/String;ZZ)V

    .line 252
    .end local v0    # "accessibilitySvcList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v2    # "intent":Landroid/content/Intent;
    :cond_0
    iget-boolean v4, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mHasFeatureIme:Z

    if-eqz v4, :cond_1

    iget-object v4, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mImeServices:Ljava/util/List;
...
.method private handlePackageUnavailable(Ljava/lang/String;)V
    ...
    .line 264
    iget-object v2, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mAccessibilityServices:Ljava/util/List;
    ...
    .line 267
    iget-object v2, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v2, v3, v4, v4}, Lcom/lenovo/settings/search/Index;->updateFromClassNameResource(Ljava/lang/String;ZZ)V

    .line 280
    :cond_0
    iget-boolean v2, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mHasFeatureIme:Z

    if-eqz v2, :cond_1

    .line 281
    iget-object v2, p0, Lcom/lenovo/settings/search/DynamicIndexableContentMonitor;->mImeServices:Ljava/util/List;
