...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/settings_ex/vpn2/VpnSettings;->isBack:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mHomeKeyReceiver:Landroid/content/BroadcastReceiver;

    .line 690
    return-void
.end method

.method static synthetic access$002(Lcom/android/settings_ex/vpn2/VpnSettings;Z)Z
    .locals 0
    ...
    .prologue
    .line 75
    iput-boolean p1, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUnlocking:Z

    return p1
.end method

.method static synthetic access$200(Lcom/android/settings_ex/vpn2/VpnSettings;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/vpn2/VpnSettings;

    .prologue
    .line 75
    invoke-direct {p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->delVpn()V
...
.method private delVpn()V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings_ex/vpn2/VpnSettings;->deleteLockdownItem(Ljava/lang/String;)Z
...
.method private deleteLockdownItem(Ljava/lang/String;)Z
    ...
    # invokes: Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->getStringOrNull(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v0, v3}, Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->access$100(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
...
.method getOwner()Lcom/android/settings_ex/vpn2/VpnSettings;
    .locals 0
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 361
    iget-object v6, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mDialog:Lcom/android/settings_ex/vpn2/VpnDialog;
    ...
    invoke-virtual {v6}, Lcom/android/settings_ex/vpn2/VpnDialog;->getProfile()Lcom/android/internal/net/VpnProfile;

    move-result-object v4

    .line 367
    .local v4, "profile":Lcom/android/internal/net/VpnProfile;
    iget-object v6, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mKeyStore:Landroid/security/KeyStore;
    ...
    # invokes: Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->getStringOrNull(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v1, v6}, Lcom/android/settings_ex/vpn2/VpnSettings$LockdownConfigFragment;->access$100(Landroid/security/KeyStore;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .line 394
    .local v2, "lockdownKey":Ljava/lang/String;
    iget-object v6, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mPreferences:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v6}, Lcom/android/settings_ex/vpn2/VpnSettings;->disconnect(Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Lcom/android/settings_ex/vpn2/VpnDialog;->isEditing()Z
    ...
    .line 430
    invoke-direct {p0, v5}, Lcom/android/settings_ex/vpn2/VpnSettings;->deleteLockdownItem(Ljava/lang/String;)Z
    ...
    invoke-direct {v3, v6, v4}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;-><init>(Landroid/content/Context;Lcom/android/internal/net/VpnProfile;)V
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 486
    iget-object v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mDialog:Lcom/android/settings_ex/vpn2/VpnDialog;
    ...
    .line 491
    :cond_0
    iget-object v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mPreferences:Ljava/util/HashMap;
    ...
    .line 499
    :pswitch_0
    new-instance v2, Lcom/android/settings_ex/vpn2/VpnDialog;

    invoke-virtual {p0}, Lcom/android/settings_ex/vpn2/VpnSettings;->getActivity()Landroid/app/Activity;

    move-result-object v4

    invoke-virtual {v1}, Lcom/android/settings_ex/vpn2/VpnSettings$VpnPreference;->getProfile()Lcom/android/internal/net/VpnProfile;

    move-result-object v5

    invoke-direct {v2, v4, p0, v5, v3}, Lcom/android/settings_ex/vpn2/VpnDialog;-><init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/internal/net/VpnProfile;Z)V

    iput-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mDialog:Lcom/android/settings_ex/vpn2/VpnDialog;

    .line 500
    iget-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mDialog:Lcom/android/settings_ex/vpn2/VpnDialog;

    invoke-virtual {v2, p0}, Lcom/android/settings_ex/vpn2/VpnDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    .line 501
    iget-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mDialog:Lcom/android/settings_ex/vpn2/VpnDialog;

    invoke-virtual {v2}, Lcom/android/settings_ex/vpn2/VpnDialog;->show()V
    ...
    new-instance v5, Lcom/android/settings_ex/vpn2/VpnSettings$2;

    invoke-direct {v5, p0}, Lcom/android/settings_ex/vpn2/VpnSettings$2;-><init>(Lcom/android/settings_ex/vpn2/VpnSettings;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/vpn2/VpnSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/os/UserManager;

    iput-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUm:Landroid/os/UserManager;

    .line 140
    iget-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUm:Landroid/os/UserManager;
    ...
    .line 141
    iput-boolean v4, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mUnavailable:Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/vpn2/VpnSettings;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
    ...
    .line 146
    :cond_0
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/vpn2/VpnSettings;->setHasOptionsMenu(Z)V

    .line 147
    const v2, 0x7f060045

    invoke-virtual {p0, v2}, Lcom/android/settings_ex/vpn2/VpnSettings;->addPreferencesFromResource(I)V
    ...
    invoke-direct {v2, v3, p0, v1, v4}, Lcom/android/settings_ex/vpn2/VpnDialog;-><init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/internal/net/VpnProfile;Z)V
    ...
    iget-object v3, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mHomeKeyReceiver:Landroid/content/BroadcastReceiver;
    ...
    sput-boolean v2, Lcom/android/settings_ex/vpn2/VpnSettings;->isBack:Z
...
.method public onDestroy()V
    ...
    .line 339
    iget-object v1, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mHomeKeyReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/android/settings_ex/vpn2/VpnSettings;->mHomeKeyReceiver:Landroid/content/BroadcastReceiver;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    invoke-direct {v0, v1, p0, v10, v2}, Lcom/android/settings_ex/vpn2/VpnDialog;-><init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/internal/net/VpnProfile;Z)V
    ...
    invoke-direct {v0, v1, p0, v2, v11}, Lcom/android/settings_ex/vpn2/VpnDialog;-><init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/internal/net/VpnProfile;Z)V
...
.method public onResume()V
    ...
    sget-boolean v9, Lcom/android/settings_ex/vpn2/VpnSettings;->isBack:Z
    ...
    .line 269
    sput-boolean v8, Lcom/android/settings_ex/vpn2/VpnSettings;->isBack:Z
