...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/Status;->myReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$800(Lcom/android/settings_ex/deviceinfo/Status;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Status;
...
.method static synthetic access$900(Lcom/android/settings_ex/deviceinfo/Status;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Status;
...
.method private setWifiStatus()V
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings_ex/deviceinfo/Status;->getString(I)Ljava/lang/String;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/android/settings_ex/deviceinfo/Status;->getImeis()Ljava/lang/String;
    ...
    .line 371
    iget-boolean v7, p0, Lcom/android/settings_ex/deviceinfo/Status;->mShowLatestAreaInfo:Z
    ...
    .line 391
    :goto_2
    iget-object v7, p0, Lcom/android/settings_ex/deviceinfo/Status;->myReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {p0, v7, v8}, Lcom/android/settings_ex/deviceinfo/Status;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    iget-object v8, p0, Lcom/android/settings_ex/deviceinfo/Status;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    .line 353
    iput-boolean v9, p0, Lcom/android/settings_ex/deviceinfo/Status;->mShowLatestAreaInfo:Z
...
.method protected onResume()V
    ...
    .line 402
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/Status;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    .line 403
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/Status;->mPhoneStateReceiver:Lcom/android/internal/telephony/PhoneStateIntentReceiver;
    ...
    invoke-direct {p0, v2}, Lcom/android/settings_ex/deviceinfo/Status;->updateServiceState(Landroid/telephony/ServiceState;)V
    ...
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/Status;->mPhoneStateListener:Landroid/telephony/PhoneStateListener;
    ...
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/Status;->mSignalStrengthListener:Landroid/telephony/PhoneStateListener;
    ...
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/Status;->mPhoneServiceListener:Landroid/telephony/PhoneStateListener;
    ...
    .line 414
    iget-boolean v2, p0, Lcom/android/settings_ex/deviceinfo/Status;->mShowLatestAreaInfo:Z

    if-eqz v2, :cond_0

    .line 415
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/Status;->mAreaInfoReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {p0, v2, v3, v4, v5}, Lcom/android/settings_ex/deviceinfo/Status;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, v1, v2, v3}, Lcom/android/settings_ex/deviceinfo/Status;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;)V
    ...
    .line 429
    :cond_1
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/Status;->mBatteryInfoReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v2, v0}, Lcom/android/settings_ex/deviceinfo/Status;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 430
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/Status;->mHandler:Landroid/os/Handler;
