...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/deviceinfo/Memory;->SEARCH_INDEX_DATA_PROVIDER:Lcom/lenovo/settings/search/Indexable$SearchIndexProvider;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mIsUsbConnected:Z
    ...
    iput-object v0, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mOtgVolume:Landroid/os/storage/StorageVolume;
...
.method static synthetic access$000(Lcom/android/settings_ex/deviceinfo/Memory;)Lcom/lenovo/settings/deviceinfo/MemoryExts;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Memory;

    .prologue
    .line 74
    iget-object v0, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMemoryExts:Lcom/lenovo/settings/deviceinfo/MemoryExts;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/settings_ex/deviceinfo/Memory;)Landroid/os/storage/StorageVolume;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Memory;

    .prologue
    .line 74
    invoke-direct {p0}, Lcom/android/settings_ex/deviceinfo/Memory;->getOtgVolume()Landroid/os/storage/StorageVolume;
...
.method static synthetic access$200(Lcom/android/settings_ex/deviceinfo/Memory;Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Memory;
    .param p1, "x1"    # Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;

    .prologue
    .line 74
    invoke-direct {p0, p1}, Lcom/android/settings_ex/deviceinfo/Memory;->addCategory(Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/settings_ex/deviceinfo/Memory;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Memory;
...
.method static synthetic access$400(Lcom/android/settings_ex/deviceinfo/Memory;Landroid/content/Context;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Memory;
    ...
    .prologue
    .line 74
    invoke-direct {p0, p1}, Lcom/android/settings_ex/deviceinfo/Memory;->getUsbState(Landroid/content/Context;)Z
...
.method static synthetic access$500(Lcom/android/settings_ex/deviceinfo/Memory;)Landroid/hardware/usb/UsbManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/Memory;
...
.method private doUnmount()V
    ...
    sget-object v4, Lcom/android/settings_ex/deviceinfo/Memory;->sClickedMountPoint:Ljava/lang/String;
    ...
    :try_start_0
    sget-object v3, Lcom/android/settings_ex/deviceinfo/Memory;->sLastClickedMountToggle:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settings_ex/deviceinfo/Memory;->getString(I)Ljava/lang/String;
    ...
    sget-object v5, Lcom/android/settings_ex/deviceinfo/Memory;->sClickedMountPoint:Ljava/lang/String;
    ...
    .line 490
    sget-object v3, Lcom/android/settings_ex/deviceinfo/Memory;->sClickedMountPoint:Ljava/lang/String;
    ...
    invoke-direct {p0, v3}, Lcom/android/settings_ex/deviceinfo/Memory;->showDialogInner(I)V
...
.method private showFormatDialog(Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V
    .locals 4
    .param p1, "category"    # Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {p1, v2, v3}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->getString(II)Ljava/lang/String;
    ...
    new-instance v3, Lcom/android/settings_ex/deviceinfo/Memory$2;

    invoke-direct {v3, p0, p1}, Lcom/android/settings_ex/deviceinfo/Memory$2;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V
    ...
    new-instance v3, Lcom/android/settings_ex/deviceinfo/Memory$3;

    invoke-direct {v3, p0}, Lcom/android/settings_ex/deviceinfo/Memory$3;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/deviceinfo/Memory;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/hardware/usb/UsbManager;

    iput-object v2, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    iput-object v2, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/deviceinfo/Memory;->addPreferencesFromResource(I)V
    ...
    iput-object v2, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMemoryExts:Lcom/lenovo/settings/deviceinfo/MemoryExts;

    .line 121
    iget-object v2, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMemoryExts:Lcom/lenovo/settings/deviceinfo/MemoryExts;
    ...
    .line 123
    invoke-static {v0}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->buildForInternal(Landroid/content/Context;)Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/android/settings_ex/deviceinfo/Memory;->addCategory(Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V
    ...
    .line 128
    invoke-static {v0, v12}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->buildForPhysical(Landroid/content/Context;Landroid/os/storage/StorageVolume;)Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/deviceinfo/Memory;->setHasOptionsMenu(Z)V
    ...
    const-class v3, Lcom/android/settings_ex/SubSettings;
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    new-instance v2, Lcom/android/settings_ex/deviceinfo/Memory$5;

    invoke-direct {v2, p0}, Lcom/android/settings_ex/deviceinfo/Memory$5;-><init>(Lcom/android/settings_ex/deviceinfo/Memory;)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 346
    iget-object v7, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMemoryExts:Lcom/lenovo/settings/deviceinfo/MemoryExts;

    sget-object v8, Lcom/android/settings_ex/deviceinfo/Memory;->sClickedMountPoint:Ljava/lang/String;
    ...
    invoke-virtual {v1, p2}, Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;->formatToggleClicked(Landroid/preference/Preference;)Z
    ...
    .line 366
    invoke-direct {p0, v1}, Lcom/android/settings_ex/deviceinfo/Memory;->showFormatDialog(Lcom/android/settings_ex/deviceinfo/StorageVolumePreferenceCategory;)V
...
.method public onResume()V
    ...
    .line 182
    iget-object v3, p0, Lcom/android/settings_ex/deviceinfo/Memory;->mMemoryExts:Lcom/lenovo/settings/deviceinfo/MemoryExts;
