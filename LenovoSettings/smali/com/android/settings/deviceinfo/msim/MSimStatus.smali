...
.method static synthetic access$000(Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;

    .prologue
    .line 78
    invoke-direct {p0}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->updateTimes()V
...
.method static synthetic access$200(Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;)Landroid/preference/Preference;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;
...
.method private setIpAddressStatus()V
    ...
    .line 476
    invoke-virtual {p0, v8}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->getString(I)Ljava/lang/String;
...
.method private updateSelectSubscribPref()V
    ...
    invoke-static {p0, v0}, Lcom/android/settings_ex/Utils;->checkIntentValid(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    .line 315
    invoke-static {p0}, Lcom/android/settings_ex/Utils;->isAirplaneModeOn(Landroid/content/Context;)Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 181
    new-instance v1, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus$MyHandler;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus$MyHandler;-><init>(Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;Lcom/android/settings_ex/deviceinfo/msim/MSimStatus$1;)V

    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->mHandler:Landroid/os/Handler;

    .line 184
    const v1, 0x7f060012

    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->addPreferencesFromResource(I)V

    .line 186
    const-string v1, "battery_level"

    invoke-virtual {p0, v1}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->mBatteryLevel:Landroid/preference/Preference;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->mBatteryStatus:Landroid/preference/Preference;
    ...
    iput-object v1, p0, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->mUptime:Landroid/preference/Preference;

    .line 218
    invoke-direct {p0}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->updateSelectSubscribPref()V
    ...
    invoke-direct {p0, v1}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->removePreferenceFromScreen(Ljava/lang/String;)V
...
.method public onPause()V
    ...
    .line 291
    iget-object v0, p0, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->mBatteryInfoReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v0}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    .line 296
    iget-object v0, p0, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->mHandler:Landroid/os/Handler;
...
.method protected onResume()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/settings_ex/deviceinfo/msim/MSimStatus;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
