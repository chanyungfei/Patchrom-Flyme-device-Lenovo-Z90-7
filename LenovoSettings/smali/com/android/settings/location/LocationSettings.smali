...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings_ex/location/LocationSettings;->SEARCH_INDEX_DATA_PROVIDER:Lcom/lenovo/settings/search/Indexable$SearchIndexProvider;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings_ex/location/LocationSettings;->mAGPSSettingPreferenceClickListener:Landroid/preference/Preference$OnPreferenceClickListener;
...
.method private addLocationServices(Landroid/content/Context;Landroid/preference/PreferenceScreen;Z)V
    ...
    new-instance v3, Lcom/android/settings_ex/location/LocationSettings$4;

    invoke-direct {v3, p0}, Lcom/android/settings_ex/location/LocationSettings$4;-><init>(Lcom/android/settings_ex/location/LocationSettings;)V
...
.method private addPreferencesSorted(Ljava/util/List;Landroid/preference/PreferenceGroup;)V
    ...
    new-instance v2, Lcom/android/settings_ex/location/LocationSettings$2;

    invoke-direct {v2, p0}, Lcom/android/settings_ex/location/LocationSettings$2;-><init>(Lcom/android/settings_ex/location/LocationSettings;)V
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0, v11}, Lcom/android/settings_ex/location/LocationSettings;->addPreferencesFromResource(I)V
    ...
    .line 270
    invoke-direct {p0, v8}, Lcom/android/settings_ex/location/LocationSettings;->setupManagedProfileCategory(Landroid/preference/PreferenceScreen;)V
    ...
    iput-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mLocationMode:Landroid/preference/Preference;

    .line 272
    iget-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mLocationMode:Landroid/preference/Preference;

    new-instance v12, Lcom/android/settings_ex/location/LocationSettings$3;

    invoke-direct {v12, p0, v0}, Lcom/android/settings_ex/location/LocationSettings$3;-><init>(Lcom/android/settings_ex/location/LocationSettings;Lcom/android/settings_ex/SettingsActivity;)V
    ...
    iput-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mAGPSSettingPreference:Landroid/preference/Preference;
    ...
    .line 304
    iget-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mAGPSSettingPreference:Landroid/preference/Preference;
    ...
    iget-object v12, p0, Lcom/android/settings_ex/location/LocationSettings;->mAGPSSettingPreferenceClickListener:Landroid/preference/Preference$OnPreferenceClickListener;
    ...
    iget-object v12, p0, Lcom/android/settings_ex/location/LocationSettings;->mLocationMode:Landroid/preference/Preference;
    ...
    iput-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mCategoryRecentLocationRequests:Landroid/preference/PreferenceCategory;
    ...
    .line 365
    iget-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mCategoryRecentLocationRequests:Landroid/preference/PreferenceCategory;

    invoke-direct {p0, v7, v11}, Lcom/android/settings_ex/location/LocationSettings;->addPreferencesSorted(Ljava/util/List;Landroid/preference/PreferenceGroup;)V
    ...
    iget-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mManagedProfile:Landroid/os/UserHandle;

    if-eqz v11, :cond_2

    iget-object v11, p0, Lcom/android/settings_ex/location/LocationSettings;->mUm:Landroid/os/UserManager;

    const-string v12, "no_share_location"

    iget-object v13, p0, Lcom/android/settings_ex/location/LocationSettings;->mManagedProfile:Landroid/os/UserHandle;
    ...
    .line 383
    :cond_2
    invoke-direct {p0, v0, v8, v4}, Lcom/android/settings_ex/location/LocationSettings;->addLocationServices(Landroid/content/Context;Landroid/preference/PreferenceScreen;Z)V

    .line 384
    const/4 v11, 0x1

    invoke-virtual {p0, v11}, Lcom/android/settings_ex/location/LocationSettings;->setHasOptionsMenu(Z)V
    ...
    .end local v6    # "recentApps":Lcom/android/settings_ex/location/RecentLocationApps;
    ...
    .line 368
    .end local v9    # "stream":Ljava/io/FileInputStream;
    .restart local v6    # "recentApps":Lcom/android/settings_ex/location/RecentLocationApps;
...
.method private updateAGPSSettingPreference()V
    ...
    .line 157
    iget-object v5, p0, Lcom/android/settings_ex/location/LocationSettings;->mAGPSSettingPreference:Landroid/preference/Preference;
    ...
    :cond_1
    :goto_1
    iget-object v4, p0, Lcom/android/settings_ex/location/LocationSettings;->mAGPSSettingPreference:Landroid/preference/Preference;
...
.method public onModeChanged(IZ)V
    ...
    .line 491
    invoke-direct {p0}, Lcom/android/settings_ex/location/LocationSettings;->updateAGPSSettingPreference()V
