...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings_ex/accounts/AccountSettings$SettingSyncStateClickListener;,
...
.method private getAccountTypePreferences(Lcom/android/settings_ex/accounts/AuthenticatorHelper;Landroid/os/UserHandle;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 389
    invoke-virtual {p1}, Lcom/android/settings_ex/accounts/AuthenticatorHelper;->getEnabledAccountTypes()[Ljava/lang/String;
    ...
    .line 393
    .local v8, "accountTypePreferences":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/settings_ex/accounts/AccountSettings$AccountPreference;>;"
    const/4 v11, 0x0
    ...
    invoke-direct {p0, p1, v7}, Lcom/android/settings_ex/accounts/AccountSettings;->accountTypeHasAnyRequestedAuthorities(Lcom/android/settings_ex/accounts/AuthenticatorHelper;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v1, v7}, Lcom/android/settings_ex/accounts/AuthenticatorHelper;->getLabelForType(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v7}, Lcom/android/settings_ex/accounts/AuthenticatorHelper;->hasAccountPreferences(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v1, v7}, Lcom/android/settings_ex/accounts/AuthenticatorHelper;->getDrawableForType(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v6

    move-object v1, p0

    invoke-direct/range {v0 .. v6}, Lcom/android/settings_ex/accounts/AccountSettings$AccountPreference;-><init>(Lcom/android/settings_ex/accounts/AccountSettings;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/String;Landroid/os/Bundle;Landroid/graphics/drawable/Drawable;)V

    .line 421
    .local v0, "tempAcc":Lcom/android/settings_ex/accounts/AccountSettings$AccountPreference;
    const v1, 0x7f040059

    invoke-virtual {v0, v1}, Lcom/android/settings_ex/accounts/AccountSettings$AccountPreference;->setLayoutResource(I)V
    ...
    invoke-virtual {p1, v1, v7}, Lcom/android/settings_ex/accounts/AuthenticatorHelper;->preloadDrawableForType(Landroid/content/Context;Ljava/lang/String;)V

    goto :goto_1

    .line 409
    .end local v0    # "tempAcc":Lcom/android/settings_ex/accounts/AccountSettings$AccountPreference;
    ...
    .line 434
    .restart local v0    # "tempAcc":Lcom/android/settings_ex/accounts/AccountSettings$AccountPreference;
    const v1, 0x7f040059
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    new-instance v1, Lcom/android/settings_ex/accounts/AccountSettings$SettingSyncStateClickListener;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/settings_ex/accounts/AccountSettings$SettingSyncStateClickListener;-><init>(Lcom/android/settings_ex/accounts/AccountSettings;Lcom/android/settings_ex/accounts/AccountSettings$1;)V
