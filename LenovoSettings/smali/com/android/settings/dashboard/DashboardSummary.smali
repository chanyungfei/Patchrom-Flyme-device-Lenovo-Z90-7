...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings_ex/dashboard/DashboardSummary$MyDSController;,
        Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;
    }
.end annotation
...
# instance fields
.field private mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;
...
.method static synthetic access$000(Lcom/android/settings_ex/dashboard/DashboardSummary;Landroid/content/Context;Z)V
    .locals 0
    ...
    .prologue
    .line 74
    invoke-direct {p0, p1, p2}, Lcom/android/settings_ex/dashboard/DashboardSummary;->rebuildUI(Landroid/content/Context;Z)V

    return-void
.end method

.method static synthetic access$100(Lcom/android/settings_ex/dashboard/DashboardSummary;Landroid/content/Context;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/dashboard/DashboardSummary;
    .param p1, "x1"    # Landroid/content/Context;
    ...
    .prologue
    .line 74
    invoke-direct {p0, p1}, Lcom/android/settings_ex/dashboard/DashboardSummary;->moveToHeaderIfNeeded(Landroid/content/Context;)V

    return-void
.end method

.method static synthetic access$200(Lcom/android/settings_ex/dashboard/DashboardSummary;Landroid/preference/PreferenceActivity$Header;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings_ex/dashboard/DashboardSummary;
    ...
    .prologue
    .line 74
    invoke-direct {p0, p1}, Lcom/android/settings_ex/dashboard/DashboardSummary;->handleNormalClick(Landroid/preference/PreferenceActivity$Header;)V
...
.method static synthetic access$500(Lcom/android/settings_ex/dashboard/DashboardSummary;)Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings_ex/dashboard/DashboardSummary;

    .prologue
    .line 74
    iget-object v0, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;
...
.method private handleNormalClick(Landroid/preference/PreferenceActivity$Header;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings_ex/dashboard/DashboardSummary;->startActivity(Landroid/content/Intent;)V
    :try_end_0
...
.method private handlePluginClick(Landroid/preference/PreferenceActivity$Header;I)V
    ...
    iget-object v2, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;

    invoke-virtual {v2, v1}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->isPluginItemEnabled(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings_ex/dashboard/DashboardSummary;->startActivity(Landroid/content/Intent;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private moveToHeaderIfNeeded(Landroid/content/Context;)V
    ...
    .line 429
    .local v3, "sa":Lcom/android/settings_ex/SettingsActivity;
    invoke-virtual {v3}, Lcom/android/settings_ex/SettingsActivity;->needToMoveDashboardHeader()Z
    ...
    .line 430
    invoke-virtual {v3}, Lcom/android/settings_ex/SettingsActivity;->getDashboardHeaderKey()Ljava/lang/String;

    move-result-object v1

    .line 431
    .local v1, "headerKey":Ljava/lang/String;
    iget-object v5, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;

    invoke-virtual {v5}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->getCount()I
    ...
    invoke-virtual {v5, v2}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->getItem(I)Ljava/lang/Object;
    ...
    .line 438
    :cond_2
    iget-object v5, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mDslv:Lcom/lenovo/settings/dslv/DragSortListView;
    ...
    :cond_3
    :goto_2
    invoke-virtual {v3}, Lcom/android/settings_ex/SettingsActivity;->revertDashboardToInitial()V
...
.method private rebuildUI(Landroid/content/Context;Z)V
    ...
    invoke-virtual {v0, v5}, Lcom/android/settings_ex/SettingsActivity;->getDashboardCategories(Z)Ljava/util/List;
    ...
    .line 380
    new-instance v5, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;
    ...
    invoke-direct {v5, v8, v4, v9}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;-><init>(Landroid/content/Context;Ljava/util/List;Lcom/android/settings_ex/accounts/AuthenticatorHelper;)V

    iput-object v5, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;
    ...
    iget-object v8, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;
    ...
    invoke-virtual {v5}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->resume()V

    .line 397
    .end local v4    # "header":Ljava/util/List;, "Ljava/util/List<Landroid/preference/PreferenceActivity$Header;>;"
    :goto_2
    invoke-virtual {p0}, Lcom/android/settings_ex/dashboard/DashboardSummary;->updateAirPlaneState()V

    .line 398
    invoke-virtual {p0}, Lcom/android/settings_ex/dashboard/DashboardSummary;->updateSimState()V
    ...
    invoke-virtual {v5}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->notifyDataSetChanged()V
...
.method private registerBroadcastReceiver()V
    ...
    iget-object v3, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAirplaneReceiver:Landroid/content/BroadcastReceiver;

    if-nez v3, :cond_0

    .line 255
    new-instance v3, Lcom/android/settings_ex/dashboard/DashboardSummary$2;

    invoke-direct {v3, p0}, Lcom/android/settings_ex/dashboard/DashboardSummary$2;-><init>(Lcom/android/settings_ex/dashboard/DashboardSummary;)V

    iput-object v3, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAirplaneReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 274
    iget-object v3, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mSimInfoReceiver:Landroid/content/BroadcastReceiver;

    if-nez v3, :cond_1

    .line 275
    new-instance v3, Lcom/android/settings_ex/dashboard/DashboardSummary$3;

    invoke-direct {v3, p0, v2}, Lcom/android/settings_ex/dashboard/DashboardSummary$3;-><init>(Lcom/android/settings_ex/dashboard/DashboardSummary;Ljava/lang/String;)V

    iput-object v3, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mSimInfoReceiver:Landroid/content/BroadcastReceiver;
    ...
    :cond_2
    :goto_1
    iget-object v3, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mPrivateModeReceiver:Landroid/content/BroadcastReceiver;

    if-nez v3, :cond_3

    .line 296
    new-instance v3, Lcom/android/settings_ex/dashboard/DashboardSummary$4;

    invoke-direct {v3, p0}, Lcom/android/settings_ex/dashboard/DashboardSummary$4;-><init>(Lcom/android/settings_ex/dashboard/DashboardSummary;)V

    iput-object v3, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mPrivateModeReceiver:Landroid/content/BroadcastReceiver;
...
.method private unregisterBroadcastReceiver()V
    ...
    .line 312
    .local v0, "context":Landroid/content/Context;
    iget-object v2, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAirplaneReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mSimInfoReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 322
    :cond_1
    iget-object v2, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mPrivateModeReceiver:Landroid/content/BroadcastReceiver;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mDslv:Lcom/lenovo/settings/dslv/DragSortListView;

    .line 124
    new-instance v0, Lcom/android/settings_ex/dashboard/DashboardSummary$MyDSController;

    iget-object v1, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mDslv:Lcom/lenovo/settings/dslv/DragSortListView;

    invoke-direct {v0, p0, v1}, Lcom/android/settings_ex/dashboard/DashboardSummary$MyDSController;-><init>(Lcom/android/settings_ex/dashboard/DashboardSummary;Lcom/lenovo/settings/dslv/DragSortListView;)V

    iput-object v0, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mController:Lcom/lenovo/settings/dslv/DragSortController;

    .line 125
    iget-object v0, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mDslv:Lcom/lenovo/settings/dslv/DragSortListView;

    iget-object v1, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mController:Lcom/lenovo/settings/dslv/DragSortController;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {v5, v4}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->getItem(I)Ljava/lang/Object;
    ...
    .line 189
    invoke-direct {p0, v2}, Lcom/android/settings_ex/dashboard/DashboardSummary;->addCharacterPluginsToWhiteList(Lcom/lenovo/settings/search/Index;)V
    ...
    .line 197
    invoke-direct {p0, v0, v4}, Lcom/android/settings_ex/dashboard/DashboardSummary;->handlePluginClick(Landroid/preference/PreferenceActivity$Header;I)V
    ...
    .line 205
    .local v1, "holder":Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;
    ...
    .end local v1    # "holder":Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;
    check-cast v1, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;

    .line 213
    .end local v3    # "itemView":Landroid/view/View;
    .restart local v1    # "holder":Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;
    :cond_6
    :goto_3
    if-eqz v1, :cond_1

    iget-object v5, v1, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;->switch_:Landroid/widget/Switch;
    ...
    .line 191
    invoke-direct {p0, v0, v2}, Lcom/android/settings_ex/dashboard/DashboardSummary;->addOtherPluginsToWhiteList(Landroid/preference/PreferenceActivity$Header;Lcom/lenovo/settings/search/Index;)V
    ...
    .end local v2    # "index":Lcom/lenovo/settings/search/Index;
    :cond_8
    invoke-direct {p0, v0}, Lcom/android/settings_ex/dashboard/DashboardSummary;->handleNormalClick(Landroid/preference/PreferenceActivity$Header;)V
...
.method public onPause()V
    ...
    .line 152
    invoke-direct {p0}, Lcom/android/settings_ex/dashboard/DashboardSummary;->unregisterBroadcastReceiver()V
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->pause()V

    .line 157
    iget-object v0, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;

    invoke-virtual {v0}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->isHeaderIndexChanged()Z
    ...
    iget-object v1, p0, Lcom/android/settings_ex/dashboard/DashboardSummary;->mAdapter:Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;

    invoke-virtual {v0, v1}, Lcom/lenovo/settings/DashboardSortUtil;->saveDragListIndex(Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;)V
...
.method public onResume()V
    ...
    .line 136
    invoke-direct {p0}, Lcom/android/settings_ex/dashboard/DashboardSummary;->registerBroadcastReceiver()V
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->resume()V
...
.method protected updateAirPlaneState()V
    ...
    invoke-virtual {v0}, Lcom/android/settings_ex/dashboard/DashboardSummary$HeaderAdapter;->updateAirPlaneMode()V
