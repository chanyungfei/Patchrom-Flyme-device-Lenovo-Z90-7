...
#!/system/bin/sh
#set -x
# function: dump the pmic8916's power rail, GPIO, MPP and clock for PM debug
#   author: yangjq
#   remark: Use tool pmic_dump to convert it to a readable analysis file
#  history: 2014-3-31, yangjq, initial version
...
#Power Rail
#Sx_CTRL
dump_ranges 0x11400 0x50 0x300 4
#Sx_FREQ
dump_ranges 0x11600 0x58 0x300 4
#LDO
dump_ranges 0x14000 0x50 0x100 20

#GPIO
dump_ranges 0xc000 0x50 0x100 4

#MPP
dump_ranges 0xa000 0x50 0x100 4

#Clock
#XO
dump_ranges 0x5000 0x50 0x100 1
#BB_CLK
