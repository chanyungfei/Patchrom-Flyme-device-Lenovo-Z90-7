...
.method private static varargs bootCommand(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    const-string v12, "bootCommand there still has file in /cache/recovery/ : "
    ...
    const-string v12, "bootCommand /cache/recovery/command delete fail, and canread="
    ...
    .line 539
    .end local v2    # "canread":Z
    .end local v3    # "canwrite":Z
    :goto_1
    ...
    .end local v5    # "command":Ljava/io/FileWriter;
    .end local v7    # "i$":I
    .end local v8    # "len$":I
    :cond_3
    const-string v10, "RecoverySystem"

    const-string v11, "bootCommand  file delete ok , /cache/recovery/command no exists "
    ...
    .restart local v5    # "command":Ljava/io/FileWriter;
    .restart local v7    # "i$":I
    .restart local v8    # "len$":I
    :cond_4
...
.method public static installPackage(Landroid/content/Context;Ljava/io/File;)V
    ...
    .line 344
    .local v2, "filename_full":Ljava/lang/String;
    move-object v0, v2

    .line 346
    .local v0, "filename":Ljava/lang/String;
    const-string/jumbo v9, "persist.fuse_sdcard"
    ...
    const-string/jumbo v9, "persist.sys.switch_storage"

    const-string v10, "emmc,0"
    ...
    .line 348
    .local v6, "mSwitchStorage":Ljava/lang/String;
    ...
    const-string/jumbo v11, "persist.fuse_sdcard: "
    ...
    const-string v11, " and persist.sys.switch_storage: "
    ...
    .line 353
    .local v7, "mSwitchStorages":[Ljava/lang/String;
    ...
    const-string v11, "adjust update package path - "
    ...
    const-string v11, " | persist.fuse_sdcard: "
    ...
    const-string v11, " | isSwitchStorage: "
