...
.method public final dumpCheckinLocked(Landroid/content/Context;Ljava/io/PrintWriter;IIZ)V
    ...
    .line 2532
    .local v100, "powerSaveModeEnabledTime":J
    move-object/from16 v0, p0
    ...
    .line 2571
    .local v94, "partialWakeTimer":Landroid/os/BatteryStats$Timer;
    if-eqz v94, :cond_1
    ...
    .end local v94    # "partialWakeTimer":Landroid/os/BatteryStats$Timer;
    ...
    .line 2954
    .local v95, "processStats":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Proc;>;"
    invoke-virtual/range {v95 .. v95}, Landroid/util/ArrayMap;->size()I
    ...
    .end local v89    # "numAnrs":I
    .end local v90    # "numCrashes":I
    ...
    .line 2973
    .local v91, "packageStats":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Pkg;>;"
    ...
    check-cast v102, Landroid/os/BatteryStats$Uid$Pkg;

    .line 2975
    .local v102, "ps":Landroid/os/BatteryStats$Uid$Pkg;
    const/16 v150, 0x0

    .line 2976
    .local v150, "wakeups":I
    invoke-virtual/range {v102 .. v102}, Landroid/os/BatteryStats$Uid$Pkg;->getWakeupAlarmStats()Landroid/util/ArrayMap;
    ...
    .line 2980
    :cond_2e
    invoke-virtual/range {v102 .. v102}, Landroid/os/BatteryStats$Uid$Pkg;->getServiceStats()Landroid/util/ArrayMap;
    ...
    .end local v91    # "packageStats":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Pkg;>;"
    .end local v95    # "processStats":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Proc;>;"
    .end local v98    # "powerCpuMaUs":J
    .end local v102    # "ps":Landroid/os/BatteryStats$Uid$Pkg;
