...
.field private mAppDrawsBackground:Z
...
.method static synthetic access$700(Landroid/app/Activity;)Z
    .locals 1
    .param p0, "x0"    # Landroid/app/Activity;
...
.method static synthetic access$800(Landroid/app/Activity;)Ljava/lang/Integer;
    .locals 1
    .param p0, "x0"    # Landroid/app/Activity;
...
.method private hookMakeVisibleForTintAndIconTheme()V
    ...
    .line 4664
    iget-boolean v3, p0, Landroid/app/Activity;->mInitialized:Z
    ...
    .line 4666
    iput-boolean v4, p0, Landroid/app/Activity;->mInitialized:Z

    .line 4669
    :cond_0
    iget-boolean v3, p0, Landroid/app/Activity;->mAppDrawsBackground:Z
    ...
    :goto_0
    iput-boolean v3, p0, Landroid/app/Activity;->mShouldSetStatusBarTint:Z
    ...
    .line 4672
    .local v0, "flags":I
    iget-boolean v3, p0, Landroid/app/Activity;->mShouldSetStatusBarTint:Z
    ...
    .line 4676
    .local v2, "sysuiVis":I
    const-string/jumbo v3, "makeVisible, pkg = %s, flags = 0x%s, sysuiVis = 0x%s"
    ...
    invoke-static {v3}, Landroid/app/Activity;->tintLog(Ljava/lang/String;)V
    ...
    .line 4683
    :cond_1
    iput-boolean v5, p0, Landroid/app/Activity;->mShouldSetStatusBarTint:Z
    ...
    const-string/jumbo v6, "systemui.tint_status_bar"
    ...
    const-string/jumbo v6, "systemui.set_icon_theme"
    ...
    :goto_2
    iput-boolean v4, p0, Landroid/app/Activity;->mShouldSetStatusBarIconTheme:Z
    ...
    const-string v4, "Check tint and icon theme, "
    ...
    iget-boolean v3, p0, Landroid/app/Activity;->mShouldSetStatusBarIconTheme:Z
    ...
    iget-object v4, p0, Landroid/app/Activity;->mStatusBarTintRunnable:Ljava/lang/Runnable;
...
.method private initTintAndIconTheme()V
    ...
    :goto_0
    iput-boolean v1, p0, Landroid/app/Activity;->mAppDrawsBackground:Z
    ...
    .line 4718
    .end local v0    # "statusBarHeightID":I
    :cond_0
    const/4 v1, 0x0
...
.method private static tintLog(Ljava/lang/String;)V
    ...
    .prologue
    .line 4831
    const-string v0, "lenovotintstatusbar"
...
.method final performRestart()V
    ...
    invoke-static {v2}, Landroid/app/Activity$ManagedCursor;->access$900(Landroid/app/Activity$ManagedCursor;)Z
    ...
    invoke-static {v2}, Landroid/app/Activity$ManagedCursor;->access$1000(Landroid/app/Activity$ManagedCursor;)Z
    ...
    invoke-static {v2, v3}, Landroid/app/Activity$ManagedCursor;->access$902(Landroid/app/Activity$ManagedCursor;Z)Z

    .line 6321
    const/4 v3, 0x0

    # setter for: Landroid/app/Activity$ManagedCursor;->mUpdated:Z
    invoke-static {v2, v3}, Landroid/app/Activity$ManagedCursor;->access$1002(Landroid/app/Activity$ManagedCursor;Z)Z
