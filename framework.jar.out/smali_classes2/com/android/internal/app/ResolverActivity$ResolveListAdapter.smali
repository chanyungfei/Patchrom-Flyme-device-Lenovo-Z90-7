...
.method private rebuildList()V
    ...
    .line 1229
    .local v19, "currentResolveList":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;>;"
    :try_start_0
    move-object/from16 v0, p0
    ...
    .end local v19    # "currentResolveList":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;>;"
    ...
    .line 1242
    .restart local v19    # "currentResolveList":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;>;"
    move-object/from16 v0, p0
    ...
    .line 1285
    .local v33, "saveRsInfo":Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;
    if-eqz v19, :cond_c
    ...
    .line 1288
    .local v32, "rsinfo":Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;->getCount()I
    ...
    .end local v32    # "rsinfo":Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;
    .end local v33    # "saveRsInfo":Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;
    :catch_0
    move-exception v30
    ...
    .line 1245
    .local v35, "shouldGetResolvedFilter":Z
    move-object/from16 v0, p0
    ...
    .line 1246
    .local v34, "shouldGetActivityMetadata":Z
    const/16 v21, 0x0
    ...
    .line 1252
    .local v24, "infos":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    if-eqz v24, :cond_5
    ...
    .line 1248
    .end local v24    # "infos":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    :cond_6
    const/4 v4, 0x0
    ...
    .end local v21    # "i":I
    .end local v34    # "shouldGetActivityMetadata":Z
    .end local v35    # "shouldGetResolvedFilter":Z
    .restart local v14    # "CtsTag":I
    .restart local v17    # "appInfo":Landroid/content/pm/ApplicationInfo;
    .restart local v18    # "count":I
    .restart local v22    # "i$":Ljava/util/Iterator;
    .restart local v23    # "index":I
    .restart local v32    # "rsinfo":Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;
    .restart local v33    # "saveRsInfo":Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;
    :cond_b
    if-eqz v17, :cond_2
    ...
    const-string v5, "com.android.cts.documentprovider"
    ...
    const-string v5, "May be running CTS: com.android.cts.documentprovider......"
    ...
    const-string v5, "remove com.android.documentsui action....."
    ...
    invoke-static {v4}, Lcom/android/internal/app/ResolverActivity;->access$400(Lcom/android/internal/app/ResolverActivity;)Lcom/android/internal/app/ResolverComparator;
    ...
    .line 1358
    .local v36, "userManager":Landroid/os/UserManager;
    ...
    :cond_16
    invoke-virtual/range {v36 .. v36}, Landroid/os/UserManager;->isManagedProfile()Z
    ...
    .end local v7    # "ri":Landroid/content/pm/ResolveInfo;
    .end local v16    # "ai":Landroid/content/pm/ActivityInfo;
    .end local v36    # "userManager":Landroid/os/UserManager;
    :cond_18
    const/4 v4, 0x0
