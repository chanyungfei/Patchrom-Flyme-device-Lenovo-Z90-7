...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/server/pm/PackageManagerService$3;->val$path:Ljava/lang/String;

    iput-object p3, p0, Lcom/android/server/pm/PackageManagerService$3;->val$tmpdex:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/server/pm/PackageManagerService$3;->val$path:Ljava/lang/String;

    const/16 v2, 0x3e8

    const/4 v3, 0x1

    iget-object v4, p0, Lcom/android/server/pm/PackageManagerService$3;->val$tmpdex:Ljava/lang/String;

    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/server/pm/Installer;->dexopt(Ljava/lang/String;IZLjava/lang/String;)I
