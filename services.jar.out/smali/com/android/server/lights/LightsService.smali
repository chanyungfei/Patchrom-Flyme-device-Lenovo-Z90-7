...
# instance fields
.field private final MSG_BUTTON_LIGHT:I

.field private lightControl:Lcom/android/server/power/LightControl;

.field private mButtonLightEnable:Z

.field private final mButtonLightService:Landroid/os/ILenovoButtonLightService$Stub;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/lights/LightsService;->mButtonLightEnable:Z

    .line 41
    const/16 v1, 0x3e8

    iput v1, p0, Lcom/android/server/lights/LightsService;->MSG_BUTTON_LIGHT:I
    ...
    iput-object v1, p0, Lcom/android/server/lights/LightsService;->mButtonLightService:Landroid/os/ILenovoButtonLightService$Stub;
...
.method static synthetic access$300(Lcom/android/server/lights/LightsService;)Lcom/android/server/power/LightControl;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/lights/LightsService;

    .prologue
    .line 32
    iget-object v0, p0, Lcom/android/server/lights/LightsService;->lightControl:Lcom/android/server/power/LightControl;

    return-object v0
.end method

.method static synthetic access$302(Lcom/android/server/lights/LightsService;Lcom/android/server/power/LightControl;)Lcom/android/server/power/LightControl;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/lights/LightsService;
    .param p1, "x1"    # Lcom/android/server/power/LightControl;

    .prologue
    .line 32
    iput-object p1, p0, Lcom/android/server/lights/LightsService;->lightControl:Lcom/android/server/power/LightControl;
...
.method public onStart()V
    ...
    .prologue
    .line 148
    const-string v0, "hardware_btn"

    iget-object v1, p0, Lcom/android/server/lights/LightsService;->mButtonLightService:Landroid/os/ILenovoButtonLightService$Stub;
