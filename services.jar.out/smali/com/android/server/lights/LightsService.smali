...
.field private mLightsControl:Lcom/android/server/lights/LightsControl;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 40
    new-array v2, v5, [Lcom/android/server/lights/LightsService$LightImpl;
    ...
    :cond_0
    :try_start_0
    new-instance v2, Lcom/android/server/lights/LightsControl;

    iget-object v3, p0, Lcom/android/server/lights/LightsService;->mService:Lcom/android/server/lights/LightsManager;

    invoke-direct {v2, p1, v3}, Lcom/android/server/lights/LightsControl;-><init>(Landroid/content/Context;Lcom/android/server/lights/LightsManager;)V

    iput-object v2, p0, Lcom/android/server/lights/LightsService;->mLightsControl:Lcom/android/server/lights/LightsControl;
    :try_end_0
    ...
    const-string v3, "create LightControl error"
...
.method static synthetic access$200(Lcom/android/server/lights/LightsService;)Lcom/android/server/lights/LightsControl;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/lights/LightsService;

    .prologue
    .line 32
    iget-object v0, p0, Lcom/android/server/lights/LightsService;->mLightsControl:Lcom/android/server/lights/LightsControl;
