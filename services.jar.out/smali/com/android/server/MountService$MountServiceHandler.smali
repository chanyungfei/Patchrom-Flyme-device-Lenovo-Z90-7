...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 504
    .local v18, "vol":Landroid/os/storage/StorageVolume;
    if-eqz v18, :cond_1
    ...
    const-string v20, "/storage/usbotg"
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/MountService;->access$400(Lcom/android/server/MountService;)Lcom/android/server/pm/PackageManagerService;
    ...
    .end local v18    # "vol":Landroid/os/storage/StorageVolume;
    :pswitch_1
    const/16 v19, 0x0
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/MountService;->access$600(Lcom/android/server/MountService;)V
    :try_end_0
    ...
    const-string v20, "Boot-time mount exception"
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/MountService;->access$700(Lcom/android/server/MountService;)V

    .line 581
    const-string v19, "MountService"

    const-string v20, "Running fstrim idle maintenance"
    ...
    invoke-static/range {v19 .. v21}, Lcom/android/server/MountService;->access$802(Lcom/android/server/MountService;J)J
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/MountService;->access$900(Lcom/android/server/MountService;)Ljava/io/File;
    ...
    invoke-static/range {v20 .. v20}, Lcom/android/server/MountService;->access$800(Lcom/android/server/MountService;)J
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/MountService;->access$1000(Lcom/android/server/MountService;)Lcom/android/server/NativeDaemonConnector;

    move-result-object v19

    const-string v20, "fstrim"
    ...
    const-string v20, "Unable to record last fstrim!"
    ...
    const-string v20, "Failed to run fstrim!"
