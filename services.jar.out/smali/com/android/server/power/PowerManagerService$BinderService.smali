...
# virtual methods
.method public acquireChargeLimiter(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;)V
    .locals 12
    ...
    const-string v1, "limiter must not be null"
    ...
    .line 3710
    :cond_1
    invoke-static {p2, p3}, Landroid/os/PowerManager;->validateChargeLimiterParameters(ILjava/lang/String;)V
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->acquireChargeLimiterInternal(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;II)V
...
.method public acquireChargeLimiterWithUid(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;I)V
    .locals 7
    .param p1, "limiter"    # Landroid/os/IBinder;
    .param p2, "flags"    # I
    .param p3, "tag"    # Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/power/PowerManagerService$BinderService;->acquireChargeLimiter(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v2, p2}, Lcom/android/server/power/PowerManagerService;->access$6000(Lcom/android/server/power/PowerManagerService;Ljava/io/PrintWriter;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public goToSleep(JII)V
    ...
    invoke-static {v1}, Lcom/android/server/power/PowerManagerService;->access$4600(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/lights/Light;
...
.method public isChargeLimiterLevelSupported(I)Z
    .locals 3
    .param p1, "level"    # I
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->isChargeLimiterLevelSupportedInternal(I)Z
...
.method public nap(J)V
    ...
    invoke-static {v3, p1, p2, v2}, Lcom/android/server/power/PowerManagerService;->access$4800(Lcom/android/server/power/PowerManagerService;JI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public reboot(ZLjava/lang/String;Z)V
    ...
    invoke-static {v2, v3, p1, p2, p3}, Lcom/android/server/power/PowerManagerService;->access$5200(Lcom/android/server/power/PowerManagerService;ZZLjava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public releaseChargeLimiter(Landroid/os/IBinder;I)V
    .locals 4
    .param p1, "limiter"    # Landroid/os/IBinder;
    .param p2, "flags"    # I
    ...
    const-string v3, "limiter must not be null"
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->releaseChargeLimiterInternal(Landroid/os/IBinder;I)V
...
.method public setBackLightProperties(Landroid/os/IBinder;Ljava/lang/String;FIIJ)V
    ...
    invoke-static/range {v1 .. v9}, Lcom/android/server/power/PowerManagerService;->access$6400(Lcom/android/server/power/PowerManagerService;Landroid/os/IBinder;Ljava/lang/String;IFIIJ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setLedDemo(ZII)V
    ...
    invoke-static {v2, p1, p2, p3}, Lcom/android/server/power/PowerManagerService;->access$5800(Lcom/android/server/power/PowerManagerService;ZII)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public shutdown(ZZ)V
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->shutdownOrRebootInternal(ZZLjava/lang/String;Z)V
    invoke-static {v2, v3, p1, v4, p2}, Lcom/android/server/power/PowerManagerService;->access$5200(Lcom/android/server/power/PowerManagerService;ZZLjava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public updateBlockedUids(IZ)V
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$6100(Lcom/android/server/power/PowerManagerService;)Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$6200(Lcom/android/server/power/PowerManagerService;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, p1, v1}, Lcom/android/server/power/PowerManagerService;->access$6300(Lcom/android/server/power/PowerManagerService;ILcom/android/server/power/PowerManagerService$WakeLock;)Z
...
.method public updateChargeLimiterUids(Landroid/os/IBinder;[I)V
    .locals 3
    .param p1, "limiter"    # Landroid/os/IBinder;
    .param p2, "uids"    # [I
    ...
    invoke-virtual {p0, p1, v1, v2}, Lcom/android/server/power/PowerManagerService$BinderService;->updateChargeLimiterWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;Ljava/lang/String;)V

    .line 3759
    return-void
.end method

.method public updateChargeLimiterWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;Ljava/lang/String;)V
    .locals 6
    .param p1, "limiter"    # Landroid/os/IBinder;
    ...
    const-string v4, "limiter must not be null"
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->updateChargeLimiterWorkSourceInternal(Landroid/os/IBinder;Landroid/os/WorkSource;Ljava/lang/String;I)V
