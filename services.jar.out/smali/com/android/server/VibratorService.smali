...
.method public vibratePattern(ILjava/lang/String;[JIILandroid/os/IBinder;)V
    ...
    const-string v3, "test pattern"

    invoke-direct {v11, v3}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;)V

    .line 285
    .local v11, "ev":Ljava/lang/RuntimeException;
    invoke-virtual {v11}, Ljava/lang/RuntimeException;->fillInStackTrace()Ljava/lang/Throwable;

    .line 286
    const-string v3, "VibratorService"

    const-string v4, "calling is: "

    invoke-static {v3, v4, v11}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
