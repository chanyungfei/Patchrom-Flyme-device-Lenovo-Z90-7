...
.method private delaySendHookKeyEvent()V
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mHandler:Lcom/android/server/media/MediaSessionService$MessageHandler;
    invoke-static {v0}, Lcom/android/server/media/MediaSessionService;->access$3100(Lcom/android/server/media/MediaSessionService;)Lcom/android/server/media/MediaSessionService$MessageHandler;
...
.method private dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    const-string v3, "MediaSessionHelper-com.lenovo.music"
    ...
    const-string v3, "MediaSessionHelper-com.lenovo.fm"
    ...
    .line 1040
    .local v16, "isMusicOrFm":Z
    :goto_1
    if-eqz v16, :cond_3

    invoke-direct/range {p0 .. p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->isMusicActive()Z
    ...
    const-string v4, ",so drop next or previous keyevent"
    ...
    .line 1105
    .end local v16    # "isMusicOrFm":Z
    .end local v17    # "sessionState":I
    :goto_2
    return-void

    .line 1033
    .restart local v17    # "sessionState":I
    :catch_0
    move-exception v15
    ...
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl$KeyEventWakeLockReceiver;->access$3300(Lcom/android/server/media/MediaSessionService$SessionManagerImpl$KeyEventWakeLockReceiver;)I
    ...
    .line 1061
    .local v18, "user":Lcom/android/server/media/MediaSessionService$UserRecord;
    # getter for: Lcom/android/server/media/MediaSessionService$UserRecord;->mLastMediaButtonReceiver:Landroid/app/PendingIntent;
    invoke-static/range {v18 .. v18}, Lcom/android/server/media/MediaSessionService$UserRecord;->access$800(Lcom/android/server/media/MediaSessionService$UserRecord;)Landroid/app/PendingIntent;
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/media/MediaSessionService$UserRecord;->access$2000(Lcom/android/server/media/MediaSessionService$UserRecord;)Landroid/content/ComponentName;
    ...
    # getter for: Lcom/android/server/media/MediaSessionService$SessionManagerImpl$KeyEventWakeLockReceiver;->mLastTimeoutId:I
    invoke-static {v4}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl$KeyEventWakeLockReceiver;->access$3300(Lcom/android/server/media/MediaSessionService$SessionManagerImpl$KeyEventWakeLockReceiver;)I
    ...
    invoke-static {v2}, Lcom/android/server/media/MediaSessionService;->access$3400(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
...
.method private handleVoiceKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    .line 928
    iput-boolean v7, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mVoiceButtonHandled:Z
    ...
    invoke-interface {v8}, Landroid/media/session/ISessionController;->getPlaybackState()Landroid/media/session/PlaybackState;
    ...
    invoke-direct {p0}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->isMusicActive()Z
    ...
    invoke-direct {v3, v7, v11}, Landroid/view/KeyEvent;-><init>(II)V
    ...
    invoke-static {v7}, Lcom/android/server/media/MediaSessionService;->access$2700(Lcom/android/server/media/MediaSessionService;)Z

    move-result v7

    invoke-direct {p0, v3, v7, p3}, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->dispatchMediaKeyEventLocked(Landroid/view/KeyEvent;ZLcom/android/server/media/MediaSessionRecord;)V

    .line 954
    new-instance v4, Landroid/view/KeyEvent;

    invoke-direct {v4, v6, v11}, Landroid/view/KeyEvent;-><init>(II)V
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mNeedWakeLock:Z
    invoke-static {v6}, Lcom/android/server/media/MediaSessionService;->access$2700(Lcom/android/server/media/MediaSessionService;)Z
    ...
    .line 964
    iput-boolean v7, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->mVoiceButtonDown:Z
...
.method private sendHookKeyEvent(ZLcom/android/server/media/MediaSessionRecord;)V
    ...
    invoke-static {v0}, Lcom/android/server/media/MediaSessionService;->access$2808(Lcom/android/server/media/MediaSessionService;)I

    .line 983
    iget-object v0, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->this$0:Lcom/android/server/media/MediaSessionService;

    # setter for: Lcom/android/server/media/MediaSessionService;->mSessionRecord:Lcom/android/server/media/MediaSessionRecord;
    invoke-static {v0, p2}, Lcom/android/server/media/MediaSessionService;->access$2902(Lcom/android/server/media/MediaSessionService;Lcom/android/server/media/MediaSessionRecord;)Lcom/android/server/media/MediaSessionRecord;

    .line 984
    iget-object v0, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->this$0:Lcom/android/server/media/MediaSessionService;

    # setter for: Lcom/android/server/media/MediaSessionService;->mNeedWakeLock:Z
    invoke-static {v0, p1}, Lcom/android/server/media/MediaSessionService;->access$2702(Lcom/android/server/media/MediaSessionService;Z)Z

    .line 985
    iget-object v0, p0, Lcom/android/server/media/MediaSessionService$SessionManagerImpl;->this$0:Lcom/android/server/media/MediaSessionService;

    # getter for: Lcom/android/server/media/MediaSessionService;->mHookKeyDownCount:I
    invoke-static {v0}, Lcom/android/server/media/MediaSessionService;->access$2800(Lcom/android/server/media/MediaSessionService;)I
    ...
    invoke-static {v0, v1}, Lcom/android/server/media/MediaSessionService;->access$3002(Lcom/android/server/media/MediaSessionService;I)I
    ...
    invoke-static {v0, v2}, Lcom/android/server/media/MediaSessionService;->access$2802(Lcom/android/server/media/MediaSessionService;I)I
...
.method private startVoiceInput(Z)V
    ...
    invoke-static {v6}, Lcom/android/server/media/MediaSessionService;->access$3500(Lcom/android/server/media/MediaSessionService;)Landroid/app/KeyguardManager;
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mMediaEventWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v4}, Lcom/android/server/media/MediaSessionService;->access$3400(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mKeyguardManager:Landroid/app/KeyguardManager;
    invoke-static {v7}, Lcom/android/server/media/MediaSessionService;->access$3500(Lcom/android/server/media/MediaSessionService;)Landroid/app/KeyguardManager;
    ...
    # getter for: Lcom/android/server/media/MediaSessionService;->mMediaEventWakeLock:Landroid/os/PowerManager$WakeLock;
    invoke-static {v5}, Lcom/android/server/media/MediaSessionService;->access$3400(Lcom/android/server/media/MediaSessionService;)Landroid/os/PowerManager$WakeLock;
