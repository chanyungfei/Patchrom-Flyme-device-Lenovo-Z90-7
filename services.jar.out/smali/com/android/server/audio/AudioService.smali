...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/audio/AudioService$FmModeStackEntry;,
        Lcom/android/server/audio/AudioService$FmModeDeathHandler;,
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/audio/AudioService;->mFmModeLock:Ljava/lang/Object;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 179
    iput v6, p0, Lcom/android/server/audio/AudioService;->storedVolumeRing:I

    .line 180
    iput v6, p0, Lcom/android/server/audio/AudioService;->storedVolumeNotification:I
    ...
    .line 6090
    iput-boolean v6, p0, Lcom/android/server/audio/AudioService;->mFmStreamOn:Z

    .line 6094
    iput v6, p0, Lcom/android/server/audio/AudioService;->mForcedUseForFM:I
    ...
    iput-object v0, p0, Lcom/android/server/audio/AudioService;->mFmModeStack:Ljava/util/Stack;
    ...
    .line 738
    invoke-direct {p0}, Lcom/android/server/audio/AudioService;->initFmMode()V
...
.method static synthetic access$10100(Lcom/android/server/audio/AudioService;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;
...
.method static synthetic access$10200(Lcom/android/server/audio/AudioService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;
...
.method static synthetic access$7100(Lcom/android/server/audio/AudioService;ZILjava/lang/String;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
...
.method static synthetic access$7200(Lcom/android/server/audio/AudioService;IILjava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$9000()Ljava/lang/Object;
    ...
    .prologue
    .line 148
    sget-object v0, Lcom/android/server/audio/AudioService;->mFmModeLock:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic access$9100(Lcom/android/server/audio/AudioService;)Ljava/util/Stack;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;

    .prologue
    .line 148
    iget-object v0, p0, Lcom/android/server/audio/AudioService;->mFmModeStack:Ljava/util/Stack;
...
.method static synthetic access$9200(Lcom/android/server/audio/AudioService;Z)V
    ...
    .prologue
    .line 148
    invoke-direct {p0, p1}, Lcom/android/server/audio/AudioService;->setFmRxMode(Z)V
...
.method static synthetic access$9800(Lcom/android/server/audio/AudioService;IIILjava/lang/String;Ljava/lang/String;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/audio/AudioService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method private broadcastRingerMode(Ljava/lang/String;I)V
    ...
    const-string v3, "broadcast ringermode,action="
...
.method private handleMediaRestartForFmMode()V
    ...
    .line 6245
    sget-object v1, Lcom/android/server/audio/AudioService;->mFmModeLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/audio/AudioService;->setFmRxMode(Z)V
...
.method private initFmMode()V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/audio/AudioService;->setFmRxMode(Z)V

    .line 6230
    sget-object v2, Lcom/android/server/audio/AudioService;->mFmModeLock:Ljava/lang/Object;

    monitor-enter v2

    .line 6231
    :try_start_0
    iget-object v1, p0, Lcom/android/server/audio/AudioService;->mFmModeStack:Ljava/util/Stack;
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "onSetWiredDeviceConnectionState:device:"
    ...
    const-string v3, "getStreamVolume music return index:"
    ...
    iget v1, v0, Lcom/android/server/audio/AudioService;->mSafeMediaVolumeIndex:I
    ...
    const-string v3, "before setStreamVolume Music Stream to index "
    ...
    const-string v3, "before setStreamVolume Ring to index "
    ...
    iput v13, v0, Lcom/android/server/audio/AudioService;->storedVolumeRing:I
    ...
    const-string v3, "before setStreamVolume Notificatoin to index "
    ...
    iput v13, v0, Lcom/android/server/audio/AudioService;->storedVolumeNotification:I
    ...
    iget v1, v0, Lcom/android/server/audio/AudioService;->storedVolumeRing:I
    ...
    const-string v3, "before restore Ring to"
    ...
    iget v3, v0, Lcom/android/server/audio/AudioService;->storedVolumeRing:I
    ...
    iget v2, v0, Lcom/android/server/audio/AudioService;->storedVolumeRing:I
    ...
    iput v1, v0, Lcom/android/server/audio/AudioService;->storedVolumeRing:I

    .line 5217
    :cond_10
    move-object/from16 v0, p0

    iget v1, v0, Lcom/android/server/audio/AudioService;->storedVolumeNotification:I
    ...
    const-string v3, "before restore Notificatoin to"
    ...
    iget v3, v0, Lcom/android/server/audio/AudioService;->storedVolumeNotification:I
    ...
    iget v2, v0, Lcom/android/server/audio/AudioService;->storedVolumeNotification:I
    ...
    iput v1, v0, Lcom/android/server/audio/AudioService;->storedVolumeNotification:I
...
.method private setFmRxMode(Z)V
    ...
    iget v0, p0, Lcom/android/server/audio/AudioService;->mFmRxMode:I
    ...
    const-string v1, "out setFmRxMode bool"
    ...
    .line 6261
    iput-boolean v3, p0, Lcom/android/server/audio/AudioService;->mFmStreamOn:Z

    .line 6262
    iput v3, p0, Lcom/android/server/audio/AudioService;->mFmRxMode:I
    ...
    invoke-static {v5, v3, v0, v1}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v5, v1}, Lcom/android/server/audio/AudioService;->makeDeviceListKey(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v2, p0, v5, v3, v4}, Lcom/android/server/audio/AudioService$DeviceListSpec;-><init>(Lcom/android/server/audio/AudioService;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 6271
    :cond_2
    iput-boolean v4, p0, Lcom/android/server/audio/AudioService;->mFmStreamOn:Z

    .line 6272
    iput v4, p0, Lcom/android/server/audio/AudioService;->mFmRxMode:I
    ...
    invoke-static {v5, v4, v0, v1}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;)I
...
.method private setRingerMode(ILjava/lang/String;Z)V
    ...
    const-string v3, "setRingerMode caller="
...
.method private setStreamVolume(IIILjava/lang/String;Ljava/lang/String;I)V
    ...
    const-string v4, "setStreamVolume caller="
...
.method public isFmActive()Z
    ...
    .prologue
    .line 6317
    iget-boolean v0, p0, Lcom/android/server/audio/AudioService;->mFmStreamOn:Z
...
.method public isSpeakerfmOn()Z
    ...
    .line 6312
    iget v1, p0, Lcom/android/server/audio/AudioService;->mForcedUseForFM:I
...
.method public onMediaServerDied()V
    ...
    const-string v4, "Media server started."
    ...
    iget-object v6, v11, Lcom/android/server/audio/AudioService$DeviceListSpec;->mDeviceAddress:Ljava/lang/String;

    iget-object v14, v11, Lcom/android/server/audio/AudioService$DeviceListSpec;->mDeviceName:Ljava/lang/String;

    invoke-static {v0, v5, v6, v14}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;Ljava/lang/String;)I
    ...
    .line 853
    iget v0, p0, Lcom/android/server/audio/AudioService;->mForcedUseForMedia:I
    ...
    invoke-static {v12}, Lcom/android/server/audio/AudioService$VolumeStreamState;->access$400(Lcom/android/server/audio/AudioService$VolumeStreamState;)I
...
.method public setFmRxMode(ILandroid/os/IBinder;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .local v3, "on":Z
    :goto_0
    invoke-direct {p0, v3}, Lcom/android/server/audio/AudioService;->setFmRxMode(Z)V

    .line 6193
    sget-object v12, Lcom/android/server/audio/AudioService;->mFmModeLock:Ljava/lang/Object;
    ...
    .line 6201
    new-instance v5, Lcom/android/server/audio/AudioService$FmModeDeathHandler;

    move-object/from16 v0, p2

    invoke-direct {v5, p0, v0}, Lcom/android/server/audio/AudioService$FmModeDeathHandler;-><init>(Lcom/android/server/audio/AudioService;Landroid/os/IBinder;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 6203
    .local v5, "afdh":Lcom/android/server/audio/AudioService$FmModeDeathHandler;
    const/4 v1, 0x0
    ...
    :goto_1
    :try_start_2
    iget-object v13, p0, Lcom/android/server/audio/AudioService;->mFmModeStack:Ljava/util/Stack;

    new-instance v1, Lcom/android/server/audio/AudioService$FmModeStackEntry;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/android/server/audio/AudioService$FmModeStackEntry;-><init>(Lcom/android/server/audio/AudioService;ZLandroid/os/IBinder;Lcom/android/server/audio/AudioService$FmModeDeathHandler;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    .line 6222
    .end local v5    # "afdh":Lcom/android/server/audio/AudioService$FmModeDeathHandler;
    :goto_2
    monitor-exit v12
    ...
    .restart local v5    # "afdh":Lcom/android/server/audio/AudioService$FmModeDeathHandler;
    :catch_0
    move-exception v9
    ...
    const-string v4, "setFmRxMode could not link to "
    ...
    check-cast v10, Lcom/android/server/audio/AudioService$FmModeStackEntry;

    .line 6216
    .local v10, "fse":Lcom/android/server/audio/AudioService$FmModeStackEntry;
    invoke-virtual {v10}, Lcom/android/server/audio/AudioService$FmModeStackEntry;->unlinkToDeath()V

    goto :goto_2

    .line 6217
    .end local v10    # "fse":Lcom/android/server/audio/AudioService$FmModeStackEntry;
    :cond_2
    if-eqz v3, :cond_3
    ...
    const-string v2, "repeated setFmRxMode on"
    ...
    const-string v2, "repeated setFmRxMode off"
...
.method public setSpeakerfmOn(Z)V
    ...
    :goto_0
    iput v0, p0, Lcom/android/server/audio/AudioService;->mForcedUseForFM:I

    .line 6301
    iget v0, p0, Lcom/android/server/audio/AudioService;->mForcedUseForFM:I

    iput v0, p0, Lcom/android/server/audio/AudioService;->mForcedUseForMedia:I
    ...
    iget v4, p0, Lcom/android/server/audio/AudioService;->mForcedUseForFM:I
    ...
    const-string v1, "out setSpeakerfmOn"
