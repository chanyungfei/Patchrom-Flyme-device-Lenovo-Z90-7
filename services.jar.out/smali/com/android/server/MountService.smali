...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/MountService$MountServiceUIHandler;,
...
.field private static final DELAYTIME_TO_REBOOT:J = 0x7530L
...
.field private static final MSG_REBOOT:I = 0x7
...
.field private static final POP_DIALOG:I = 0x6

.field private static final PRIMARY_SD_MISS:I = 0x8

.field private static final PRIMARY_SD_SAME:I = 0x9
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 398
    iput-boolean v2, p0, Lcom/android/server/MountService;->isPopUP:Z
    ...
    invoke-direct {v0, p0}, Lcom/android/server/MountService$7;-><init>(Lcom/android/server/MountService;)V

    iput-object v0, p0, Lcom/android/server/MountService;->mNotifySDListener:Landroid/content/DialogInterface$OnDismissListener;
    ...
    .line 1713
    new-instance v0, Lcom/android/server/MountService$MountServiceUIHandler;

    invoke-direct {v0, p0}, Lcom/android/server/MountService$MountServiceUIHandler;-><init>(Lcom/android/server/MountService;)V

    iput-object v0, p0, Lcom/android/server/MountService;->mUIHandler:Landroid/os/Handler;
...
.method static synthetic access$1200(Lcom/android/server/MountService;)Landroid/os/Handler;
    ...
    .prologue
    .line 131
    iget-object v0, p0, Lcom/android/server/MountService;->mUIHandler:Landroid/os/Handler;
...
.method static synthetic access$1300(Lcom/android/server/MountService;Z)V
    ...
    .prologue
    .line 131
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->NotifiedSD(Z)V
...
.method static synthetic access$1500(Lcom/android/server/MountService;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$1600(Lcom/android/server/MountService;Landroid/os/UserHandle;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$3502(Lcom/android/server/MountService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/MountService;
...
.method static synthetic access$3600(Lcom/android/server/MountService;)V
    ...
    .prologue
    .line 131
    invoke-direct {p0}, Lcom/android/server/MountService;->clearDatabase()V
...
.method private clearDatabase()V
    ...
    const-string v1, "delete external database before reboot"

    invoke-static {v0, v1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 3441
    const-string v0, "sys.jcommand_para"

    const-string v1, "[CLEAR_DATABASE]"
...
.method private createEmulatedVolumeLocked(Landroid/os/UserHandle;Ljava/lang/String;)V
    .locals 5
    .param p1, "user"    # Landroid/os/UserHandle;
    ...
    invoke-static {v2, v0, p1}, Landroid/os/storage/StorageVolume;->fromTemplate(Landroid/os/storage/StorageVolume;Ljava/io/File;Landroid/os/UserHandle;)Landroid/os/storage/StorageVolume;
    ...
    const-string v4, "liuxu 111, create emulated volume: "
...
.method private doUnmountVolume(Ljava/lang/String;ZZ)I
    ...
    const-string v7, "/storage/usbotg"
...
.method private isSdAsPrimaryStorage(Ljava/lang/String;)Z
    .locals 3
    .param p1, "path"    # Ljava/lang/String;
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    .line 1173
    .local v0, "OTG_path":Ljava/lang/String;
    iget-object v6, p0, Lcom/android/server/MountService;->mVolumesLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, p2}, Lcom/android/server/MountService;->isSdAsPrimaryStorage(Ljava/lang/String;)Z
    ...
    .line 1190
    iget-object v5, p0, Lcom/android/server/MountService;->mUIHandler:Landroid/os/Handler;
    ...
    invoke-direct {p0, v1, v4, v5}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    const-string v6, "sd is replaced,when sd is primary storage"
    ...
    const-string v6, "USB disconnection happened when doing share operation, remount"
    ...
    invoke-direct {p0, v5}, Lcom/android/server/MountService;->notifyShareAvailabilityChange(Z)V
...
.method private readStorageListLocked()V
    ...
    .line 1527
    .local v25, "primaryPath":Ljava/lang/String;
    ...
    .line 1577
    .local v28, "userManager":Lcom/android/server/pm/UserManagerService;
    const/4 v3, 0x0
    ...
    invoke-direct {v0, v3, v1}, Lcom/android/server/MountService;->createEmulatedVolumeLocked(Landroid/os/UserHandle;Ljava/lang/String;)V
    :try_end_1
    ...
    .end local v28    # "userManager":Lcom/android/server/pm/UserManagerService;
    :catch_0
    move-exception v16
...
.method private showSdcardWarningDlg()V
    ...
    const-string v2, "showSdcardWarningDlg"
...
.method private updatePublicVolumeState(Landroid/os/storage/StorageVolume;Ljava/lang/String;)V
    ...
    const-string v7, "Disk/Partition bad remove call PMS"
    ...
    invoke-virtual {v6, v4}, Lcom/android/server/pm/PackageManagerService;->unloadInstalledExternalPackages(Ljava/lang/String;)V
...
.method public encryptStorage(ILjava/lang/String;)I
    ...
    const-string v5, "in encryptStorage type"
    ...
    .line 2530
    const-string v3, "persist.sys.encrypt_num"
    ...
    .line 2531
    const-string v3, "persist.sys.encrypt_type"
    ...
    .line 2532
    const-string v3, "persist.sys.encrypt_pw"
    ...
    const-string v7, "enablecrypto"

    aput-object v7, v5, v6

    const/4 v6, 0x1

    const-string v7, "inplace"
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string v21, " Has Disk isnert :"
    ...
    const-string v20, "VolumeBadToReboot"
    ...
    iget-boolean v0, v0, Lcom/android/server/MountService;->isPopUP:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/MountService;->isPopUP:Z

    .line 1155
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/MountService;->mUIHandler:Landroid/os/Handler;
