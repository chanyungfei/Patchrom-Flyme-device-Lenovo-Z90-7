...
.method public systemReady()V
    ...
    .line 70
    iput-boolean v5, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mIsServiceReady:Z

    .line 72
    iget-object v2, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mContext:Landroid/content/Context;
    ...
    new-instance v2, Lcom/android/server/display/brightnesscontroller/LightAdjustService$SettingsObserver;

    new-instance v3, Landroid/os/Handler;

    invoke-direct {v3}, Landroid/os/Handler;-><init>()V

    invoke-direct {v2, p0, v3}, Lcom/android/server/display/brightnesscontroller/LightAdjustService$SettingsObserver;-><init>(Lcom/android/server/display/brightnesscontroller/LightAdjustService;Landroid/os/Handler;)V

    iput-object v2, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mSettingsObserver:Lcom/android/server/display/brightnesscontroller/LightAdjustService$SettingsObserver;
    ...
    iget-object v3, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mSettingsObserver:Lcom/android/server/display/brightnesscontroller/LightAdjustService$SettingsObserver;
    ...
    .line 80
    iget-object v2, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mIntentFilter:Landroid/content/IntentFilter;
    ...
    iget-object v3, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->myBroadcastReceiver:Lcom/android/server/display/brightnesscontroller/LightAdjustService$MyBroadcastReceiver;

    iget-object v4, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mIntentFilter:Landroid/content/IntentFilter;

    invoke-virtual {v2, v3, v4}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 91
    iget-object v2, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mTwilight:Lcom/android/server/twilight/TwilightManager;

    iget-object v3, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mTwilightListener:Lcom/android/server/twilight/TwilightListener;
    ...
    .line 94
    iget-object v2, p0, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->mProcessCore:Lcom/android/server/display/brightnesscontroller/LightAdjuestCore;

    invoke-virtual {v2}, Lcom/android/server/display/brightnesscontroller/LightAdjuestCore;->initCallback()V
    ...
    invoke-virtual {p0, v5, v0}, Lcom/android/server/display/brightnesscontroller/LightAdjustService;->updateBrightnessControllerState(ZZ)V
